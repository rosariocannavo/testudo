  ...
  E: Pairing,
{
  ...
  pub fn setup(
    ...
    num_vars: usize,
    num_inputs: usize,
    poseidon: PoseidonConfig<E::BaseField>,
  ) -> Self {
  ...
  E::ScalarField: Absorb,
{
  fn prove_phase_one(
    ...
    let (sc_proof_phase_one, r, claims) = SumcheckInstanceProof::prove_cubic_with_additive_term::<_, E>(
  ...
  pub fn prove(
    ...
    let initial_state: <E as Pairing>::ScalarField = transcript.challenge_scalar(b"");
    transcript.new_from_state2(&initial_state);
    ...
    transcript.new_from_state2(&transcript_sat_state);
...
//   use crate::{rand::SeedableRng, parameters::get_bls12377_fq_params};
...
//     let mut prover_transcript = PoseidonTranscript::new(&params_to_base_field::<P>());
//     let c = prover_transcript.challenge_scalar::<P::ScalarField>(b"");
//     prover_transcript.new_from_state2(&c);
